...
class StoneLauncherTest {

    @Test
    public void shouldFindSumOfInitialStoneCoordinates() {
        ...
        assertEquals(47L, new StoneLauncher(hailstones).findSumOfInitialStoneCoordinates());
    }
